...
export class AzureCsvFileInput extends BaseCoreComponent {
  constructor() {
      ...
      fields: [
        {
          ...
          label: "File path",
          id: "filePath",
          placeholder: "Blob Type file name",
    ...
    super("Blob CSV File Input", "azureCsvFileInput", "no desc", "pandas_df_input", ["csv", "tsv"], "inputs", fileTextIcon, defaultConfig, form);
  }
