...
export class AzureBlobFileOutput extends BaseCoreComponent {
  constructor() {
    ...
    super("Azure Blob File Output", "fileOutput", description, "pandas_df_output", [], "outputs.Azure", azureServicesIcon, defaultConfig, form);
  }
