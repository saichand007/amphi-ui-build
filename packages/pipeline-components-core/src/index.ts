...
import {
  ...
  AzureBlobFileInput, AzureBlobFileOutput,
...
export { Aggregate, Console, ExcelFileOutput, CsvFileInput, JsonFileInput, JsonFileOutput, ExcelFileInput, CsvFileOutput, CustomTransformations, Filter, RestInput,
  ...
  ParquetFileInput, ParquetFileOutput, PostgresInput, PostgresOutput, MySQLInput, MySQLOutput, XmlFileInput, XmlFileOutput, DateTimeConverter,
  EnvVariables, EnvFile, Transpose, Unite, Pivot, Annotation, ODBCInput, PdfTablesInput, Summary, LocalFileInput, FlattenJSON,
  DataCleansing, GenerateIDColumn, SqlServerInput, OracleInput, Connection, SnowflakeInput, FormulaRow, InlineInput, S3FileOutput, S3FileInput,AzureBlobFileInput,
  AzureBlobFileOutput,SnowflakeOutput, SqlServerOutput, OracleOutput, CustomInput, CustomOutput, FileUtils, FrequencyAnalysis, FormExample }
...
const plugin: JupyterFrontEndPlugin<void> = {
  ...
  activate: (app: JupyterFrontEnd, componentService: any) => {
    ...
    componentService.addComponent(AzureBlobFileInput.getInstance())
    ...
    componentService.addComponent(AzureBlobFileOutput.getInstance())
